...
# Only enable PSReadLine prediction features when VT is supported (not in redirected/non-VT consoles)
if ($Host.UI.SupportsVirtualTerminal -and [Console]::IsOutputRedirected -eq $false) {
